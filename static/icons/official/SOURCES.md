...
| --- | --- | --- |
| Keil µVision 5 | `keil-uvision5.png` | Application icon exported at 256 px from the locally installed official `UV4.exe`; [Keil MDK](https://www.keil.arm.com/) |
...
| Proteus Design Suite | `proteus.png` | Application icon exported at 256 px from the locally installed official Labcenter Electronics installer resource; [Proteus Design Suite](https://www.labcenter.com/) |
| 嘉立创 JLCPCB | `jlcpcb.webp` | [JLCPCB homepage logo](https://rs.jlcpcb.com/static/image/homepage/jlcpcb-logo.webp) |
| Altium Designer | `altium-designer.svg` | [Altium Designer product mark](https://cdn.files.altium.com/sites/default/files/media_icon/2021-07/se_logo.svg), labeled “AD Logo” on [Altium's product page](https://www.altium.com/in) |
| LaTeX | `latex.svg` | [LaTeX Project logo](https://www.latex-project.org/about/logos/latex-project-logo_288x288.svg) and its [usage guidance](https://www.latex-project.org/about/logos/) |
| Wireshark | `wireshark.png` | [`resources/icons/wsicon256.png`](https://gitlab.com/wireshark/wireshark/-/raw/master/resources/icons/wsicon256.png) in the official Wireshark repository |

All product names, logos, and trademarks remain the property of their
respective owners.
