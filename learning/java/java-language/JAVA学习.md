...
| 命令                                            | 说明（作用）                            |
| ----------------------------------------------- | --------------------------------------- |
| `System.out.println(2025);`                     | 在屏幕上输出数字：`2025`                |
| `System.out.println("Ciao 🍕");`                 | 在屏幕上输出文本：`Ciao 🍕`              |
| `System.out.println("こんにちは 🗾");`           | 在屏幕上输出文本：`こんにちは 🗾`        |
| System.out.println("我的年龄：" + 28);          | 字符串可以用 + 来相加，更准确地说是拼接 |
| System.out.println("现在是 " + 2025 + " 年。"); | 把多段字符串连续拼接                    |
