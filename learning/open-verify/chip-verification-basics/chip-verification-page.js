(function () {
  ...
  function preparePages(markdown) {
    ...
    if (!pages.length) {
      var fallbackId = uniqueAnchor('document-title');
      pages.push({
        title: siteTitle,
        anchorId: fallbackId,
        aliases: [],
  ...
  function syncComments(page) {
    ...
    var issueTerm = '万众一芯学习笔记评论：芯片验证基础知识：' + page.plainTitle;
  ...
  function renderPage(pageIndex, targetId) {
    ...
    content.innerHTML = '<header class="doc-page-header"><p class="doc-page-kicker">万众一芯 · 第 ' +
    ...
    document.title = page.plainTitle + ' · 芯片验证基础知识 · 万众一芯 · Kyle';
  ...
  fetch('./芯片验证基础知识.md?v=20260908a')
    ...
    .catch(function () {
      ...
      content.innerHTML = '<header class="doc-page-header"><p class="doc-page-kicker">万众一芯</p><h1>芯片验证基础知识</h1></header><p>笔记暂时无法加载，请刷新页面重试，或<a href="../">返回万众一芯目录</a>。</p>';
